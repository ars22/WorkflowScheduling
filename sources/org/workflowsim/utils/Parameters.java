...
public class Parameters {
	...
	public static WorkflowPlanner wfPlanner;
    
	public static List<Task> taskList;
	
	public static WorkflowDatacenter datacenter;
    ...
    public enum SchedulingAlgorithm {
        ...
        STATIC, FCFS, ROUNDROBIN, INVALID, PSO, PSOTEST, CPSO
    }
    ...
    public enum PlanningAlgorithm{
        INVALID, RANDOM, HEFT, DHEFT, ARHEFT, RHEFT, CHEFT
    }
